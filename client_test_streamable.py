#!/usr/bin/env python3
"""
Test client using MCP Python SDK with Streamable HTTP transport
Connects to the proxy's /mcp endpoint using the official SDK
"""
import asyncio
...
async def main():
    """Test the MCP proxy using the SDK's Streamable HTTP transport"""
    print("=" * 60)
    print("MCP SDK Client Test (Streamable HTTP Transport)")
    print("=" * 60)
